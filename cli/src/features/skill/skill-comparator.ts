...
export class SkillComparator {
  ...
  public buildComparisonRows(
    ...
    return platformTargets.flatMap(platformTarget =>
      skillIndexEntries.map((skillIndexEntry) => {
        ...
        try {
          const localSkillVersion = this.skillDocumentParser.parseSkillVersion(
   ...
   */
  public buildUpdateRows(comparisonRows: readonly ISkillComparisonRow[]): ISkillComparisonRow[] {
   ...
   */
  public buildUpdateSkillNames(comparisonRows: readonly ISkillComparisonRow[]): string[] {
